...
const Personalinformation = () => {
  ...
  const inputsForCurrentStep = [
    ...
    {
      name: "weight",
      placeholder: "What is your weight? (pounds)",
    },
    {
      name: "age",
  ...
  const handleNextInput = () => {
    ...
    if (inputsForCurrentStep[currentInputIndex].name === "height") {
    ...
    if (inputsForCurrentStep[currentInputIndex].name === "weight") {
      console.log("Form Data:", formData);
      saveToLocalStorage(
        inputsForCurrentStep[currentInputIndex].placeholder,
  ...
  const isCurrentInputValid =
    inputsForCurrentStep[currentInputIndex].name === "height"
      ...
      : inputsForCurrentStep[currentInputIndex].name === "age"
      ? Number(formData.age) >= 1 && Number(formData.age) <= 100
      : formData[inputsForCurrentStep[currentInputIndex].name]?.trim() !== "";

  console.log(
    "physicaldetails formData[inputsForCurrentStep[currentInputIndex]]",
    formData[inputsForCurrentStep[currentInputIndex]]
  );
  console.log(
    "physicaldetails formData[inputsForCurrentStep[currentInputIndex].name]",
    formData[inputsForCurrentStep[currentInputIndex].name]
  );
  console.log("formData", formData);
          ...
          {inputsForCurrentStep[currentInputIndex].name === "gender" ? (
            ...
            <div>
              <input
                ...
                //   inputsForCurrentStep[currentInputIndex].placeholder
                // }
                placeholder="Feet (must be between 1 and 8)"
                className="w-2/4 px-4 py-3 bg-[#1D192999] text-[#A5A3A9] rounded-3xl border-none focus:outline-none placeholder-[#A5A3A9] font-medium focus-within:bg-gradient-to-lfocus-within:from-[#1A50FF] focus-within:to-[#D96FF8]"
              ...
              <input
                ...
                min="0"
                max="11"
                placeholder="Inches (must be between 0 and 11)"
                className="w-2/4 px-4 py-3 bg-[#1D192999] text-[#A5A3A9] rounded-3xl border-none focus:outline-none placeholder-[#A5A3A9] font-medium "
                // value={formData[inputsForCurrentStep[currentInputIndex].name]}
              ...
              {/* {errors.inches && (
                <span className="text-red-500 text-sm ml-60">
                  {errors.inches}
                </span>
              )} */}
            </div>
            ...
            <input
              type="number"
              name={inputsForCurrentStep[currentInputIndex].name}
              // placeholder={"What is your weight? (between 5 and 1400 pounds)"}
